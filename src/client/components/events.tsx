...
import { IconBranchOutlineRegular, IconPlusOutlineRegular } from '@deepseek-ai/dsh-client-ui-primitives'
    ...
    return (
      <div className="lc-events" ref={rootRef}>
        {sorted.map((ev) => {
          ...
          const at = eventAt(ev)
          const glyph = ev.kind === 'inject' ? <IconPlusOutlineRegular size={16} />
            : ev.kind === 'model' ? <IconBranchOutlineRegular size={16} />
              : EVENT_ICONS[ev.kind] || '•'
