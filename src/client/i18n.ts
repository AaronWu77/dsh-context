...
export const DICT_ZH: Record<string, string> = {
  ...
  'settings.title': '额度与用量', 'settings.desc': 'dsh-context 插件中额度与用量面板的偏好设置',
...
export const DICT_EN: Record<string, string> = {
  ...
  'settings.title': 'Quota & Usage', 'settings.desc': 'Preferences for the Quota & Usage panel in dsh-context plugin',
