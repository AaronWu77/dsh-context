...
export const DICT_ZH: Record<string, string> = {
  ...
  'ov.kpi.tokens': '累计消耗',
  'ov.kpi.costSub': 'models.dev 刊例价估算',
  'ov.kpi.cacheSub': '缓存读取 / 计费输入',
  'ov.heat.title': '活跃度',
  'ov.heat.sub': '近 12 周 · 点击日期可筛选会话',
  'ov.heat.empty': '暂无活跃数据 — 会话产生模型请求后，这里会显示每日用量',
  'ov.heat.calls': '{n} 次请求',
  'ov.heat.wd.1': '一', 'ov.heat.wd.3': '三', 'ov.heat.wd.5': '五',
  'ov.comp.title': '上下文构成（合计）',
  'ov.comp.empty': '范围内暂无可统计的上下文数据',
  'ov.list.title': '会话',
  'ov.list.search': '搜索标题或目录…',
  'ov.list.sortLabel': '排序',
  'ov.list.sort.recent': '最近活跃', 'ov.list.sort.tokens': '消耗', 'ov.list.sort.context': '上下文',
...
export const DICT_EN: Record<string, string> = {
  ...
  'ov.entry': 'Context Dashboard',
  'ov.title': 'Context Dashboard',
  ...
  'ov.kpi.costSub': 'estimated at models.dev list prices',
  'ov.kpi.cacheSub': 'cache reads of billed input',
  'ov.heat.title': 'Activity',
  'ov.heat.sub': 'Last 12 weeks · click a day to filter sessions',
  'ov.heat.empty': 'No activity yet — daily usage appears once sessions make model requests',
  'ov.heat.calls': '{n} requests',
  'ov.heat.wd.1': 'M', 'ov.heat.wd.3': 'W', 'ov.heat.wd.5': 'F',
  'ov.comp.title': 'Context Composition (Total)',
  'ov.comp.empty': 'No context data in this range yet',
  'ov.list.title': 'Sessions',
  'ov.list.search': 'Search title or path…',
  'ov.list.sortLabel': 'Sort',
  'ov.list.sort.recent': 'Recent', 'ov.list.sort.tokens': 'Tokens', 'ov.list.sort.context': 'Context',
