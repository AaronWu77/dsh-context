window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-util-works_f605195fb78868d4aa4b402f3bddcfe5/node_modules/@deepseek-ai/dsh-util-workspace-path/lib/index.js
		/**
		...
		*/
		function makeQuotaGrid(ctx, kit) {
			...
			return function QuotaGrid(props) {
				...
				if (props.compact === true) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function createContextSettings() {
			...
			return {
				...
				set(field, value) {
					...
					attached.set(field, value).catch(() => {
