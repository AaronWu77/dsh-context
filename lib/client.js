		...
		*/
		function makeQuotaGrid(ctx, kit) {
			...
			return function QuotaGrid(props) {
				...
				const cell = (key, label, value, sub, target, extra) => {
				...
				for (const account of accounts) {
					...
					for (const win of windows) {
						...
						const accountBadge = named ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "lc-ov-quota-acct" + (account.active ? " lc-ov-quota-acct-on" : ""),
							children: account.label === "" ? t("ov.quota.accountCurrent") : account.label
						}) : null;
						cells.push(cell(key, /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [t("ov.quota.codexWindow", { w: windowLabel(win.windowSeconds) }), accountBadge] }), t("ov.quota.remaining", { p: Math.round(win.remainingPercent) }), reset === null ? null : t("ov.quota.resetIn", { d: reset }), {
							kind: "window",
							key
						}));
					}
