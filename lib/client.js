window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const DICT_ZH = {
			"tab": "额度与用量",
			"sidebar.guideDescription": "查看账户余额、额度与今日用量。",
			"cat.system": "系统提示词",
			"cat.tools": "工具定义",
			"cat.user": "用户消息",
			"cat.inject": "注入内容",
			...
			"gran.step": "步骤",
			"gran.turn": "轮次",
			"settings.title": "额度与用量",
			"settings.desc": "dsh-context 插件中额度与用量面板的偏好设置",
			"settings.placement": "入口位置",
			"placement.tab": "标签页",
			"placement.sidebar": "侧边栏",
			"placement.all": "全部",
			"settings.insightsEntry": "额度与用量入口",
			"insightsEntry.show": "显示",
			"insightsEntry.hide": "隐藏",
			...
			"ov.quota.balance": "账户余额",
			"ov.quota.balanceSub": "赠金 {granted} · 充值 {topped}",
			"ov.quota.codex5h": "Codex 5 小时额度",
			"ov.quota.codexWeek": "Codex 周额度",
			"ov.quota.resetIn": "{d} 后重置",
			"ov.quota.codexWindow": "Codex {w} 额度",
			"ov.quota.remaining": "剩余 {p}%",
			"ov.quota.today": "今日用量",
			"ov.quota.accountCurrent": "当前",
			"ov.quota.legend": "账号对照",
			"ov.quota.detail.total": "总额",
			"ov.quota.detail.granted": "赠金",
			"ov.quota.detail.topped": "充值",
			"ov.quota.detail.currency": "币种",
			"ov.quota.detail.sessions": "活跃会话",
			"ov.quota.detail.requests": "请求数",
			"ov.quota.detail.account": "账号",
			"ov.quota.detail.length": "窗口长度",
			"ov.quota.detail.remaining": "剩余额度",
			"ov.quota.detail.resetAt": "重置时刻",
			"ov.quota.detail.refreshed": "上次刷新",
			"ov.quota.detail.ago": "前",
			"ov.quota.detail.filterDay": "在会话列表里只看今天",
			...
			"ov.list.sort.recent": "最近更新",
			"ov.list.sort.tokens": "Token 总用量",
			"ov.list.sort.context": "当前 Context",
		...
		const DICT_EN = {
			"tab": "Quota & Usage",
			"sidebar.guideDescription": "Inspect the account balance, quota, and daily usage.",
			...
			"gran.step": "Step",
			"gran.turn": "Turn",
			"settings.title": "Quota & Usage",
			"settings.desc": "Preferences for the Quota & Usage panel in dsh-context plugin",
			"settings.placement": "Entry Options",
			"placement.tab": "Tab",
			"placement.sidebar": "Sidebar",
			"placement.all": "All",
			"settings.insightsEntry": "Quota & Usage entry",
			"insightsEntry.show": "Show",
			"insightsEntry.hide": "Hide",
			...
			"cmd.label": "Quota & Usage",
			"cmd.section": "Quota & Usage",
			"cmd.desc": "Inspect the account balance, quota, and daily usage",
			"cmd.close": "Close",
			...
			"ov.entry": "Quota & Usage",
			"ov.title": "Quota & Usage",
			...
			"ov.quota.balance": "Balance",
			"ov.quota.balanceSub": "granted {granted} · topped up {topped}",
			"ov.quota.codex5h": "Codex 5-hour quota",
			"ov.quota.codexWeek": "Codex weekly quota",
			"ov.quota.resetIn": "resets in {d}",
			"ov.quota.codexWindow": "Codex {w} quota",
			"ov.quota.remaining": "{p}% left",
			"ov.quota.today": "Today",
			"ov.quota.accountCurrent": "current",
			"ov.quota.legend": "Accounts",
			"ov.quota.detail.total": "Total",
			"ov.quota.detail.granted": "Granted",
			"ov.quota.detail.topped": "Topped up",
			"ov.quota.detail.currency": "Currency",
			"ov.quota.detail.sessions": "Active sessions",
			"ov.quota.detail.requests": "Requests",
			"ov.quota.detail.account": "Account",
			"ov.quota.detail.length": "Window",
			"ov.quota.detail.remaining": "Remaining",
			"ov.quota.detail.resetAt": "Resets at",
			"ov.quota.detail.refreshed": "Last refreshed",
			"ov.quota.detail.ago": "ago",
			"ov.quota.detail.filterDay": "Show only today in the list",
			...
			"ov.list.sort.recent": "Last updated",
			"ov.list.sort.tokens": "Total Tokens",
			"ov.list.sort.context": "Current Context",
		...
		*/
		function activityOf$1(value) {
			...
			for (const key of Object.keys(rawDays)) {
				...
				if (!/^\d{4}-\d{2}-\d{2}$/.test(key) || entry === null || Array.isArray(entry) || typeof tokens !== "number" || !Number.isFinite(tokens) || tokens < 0 || typeof requests !== "number" || !Number.isFinite(requests) || requests < 0) {
					dirty = true;
					continue;
				}
				days[key] = {
		...
		function makeRichText(kit) {
			...
			function RichCopy(props) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					"aria-label": label,
					onClick: onCopy,
					children: copied ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutlineRegular, { size: 13 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutlineRegular, { size: 13 })
				});
			}
				...
				const catBody = (c) => {
					...
					const rows = (byCat[c] ?? []).slice().reverse().map((n) => {
						...
						if (n.cat === "tool") {
							...
							preview = (n.skill === void 0 && id !== "" ? id : null) ?? (n.text !== void 0 && n.text !== "" ? n.text : null) ?? callSummaryOf(conv) ?? preview;
							...
							if (id !== "") preview = id;
							else if (n.text !== void 0 && n.text !== "") preview = n.form === "snapshot" ? t("node.snapshot") + n.text : n.text;
						}
						return {
							n,
							conv,
					...
					const q = rowQuery.trim().toLowerCase();
					const shown = q === "" ? rows : rows.filter((r) => (r.tag ?? "").toLowerCase().includes(q) || r.preview.toLowerCase().includes(q) || typeof r.n.text === "string" && r.n.text.toLowerCase().includes(q));
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: CATS.map((c) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
										type: "button",
										className: "lc-br-cat-row hover:bg-(--dsw-alias-interactive-bg-hover)" + (open ? " lc-br-cat-open" : "") + (linked && props.hoverKey === c.key ? " lc-br-cat-on" : ""),
		...
		*/
		...
		//#endregion
		//#region src/client/overviewStore.ts
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-util-works_eb41412f5320dadc9f93fd95ecbef98b/node_modules/@deepseek-ai/dsh-util-workspace-path/lib/index.js
		/**
		...
		*/
		function mergeInto(out, usage) {
			if (usage === null || usage === void 0) return false;
			let any = false;
			for (const provider of Object.keys(usage)) {
				const models = asRecord(usage[provider]);
				if (models === null || Array.isArray(models)) continue;
		...
		*/
		function mergeCostUsage(...usages) {
			const out = {};
			let any = false;
			for (const usage of usages) if (mergeInto(out, usage)) any = true;
			return any ? out : null;
		}
		...
		*/
		function sessionsSnapshotOf(props) {
			const useSessions = props.useSessions;
			if (typeof useSessions !== "function") return null;
			try {
				return useSessions((snapshot) => snapshot);
			} catch {
				return null;
			}
		}
		...
		*/
		function workspacesSnapshotOf(props) {
			const useWorkspaces = props.useWorkspaces;
			if (typeof useWorkspaces !== "function") return null;
			try {
				return useWorkspaces((snapshot) => snapshot);
			} catch {
				return null;
			}
		}
		...
		*/
		function sessionGroupsOf(snapshot) {
			...
			for (const item of state.items) {
				...
				const title = typeof workspace.title === "string" && workspace.title !== "" ? workspace.title : void 0;
				if (title === void 0 || !Array.isArray(workspace.sessionIds)) continue;
				for (const id of workspace.sessionIds) if (typeof id === "string" && claimed[id] === void 0) groups[id] = title;
			}
			return groups;
		}
		...
		*/
		function groupCountsOf(rows, snapshot) {
			const state = asRecord(snapshot);
			...
			for (const item of state.items) {
				...
				if (title === void 0 || !Array.isArray(workspace.sessionIds)) continue;
				titles.push(title);
				for (const id of workspace.sessionIds) if (typeof id === "string" && !claimed.has(id)) claimed.set(id, title);
			}
			const counts = /* @__PURE__ */ new Map();
			let ungrouped = 0;
			for (const row of rows) {
				const title = claimed.get(row.id);
				if (title === void 0) ungrouped++;
				else counts.set(title, (counts.get(title) ?? 0) + 1);
			}
			const groups = [];
			for (const title of titles) {
				const count = counts.get(title) ?? 0;
				if (count > 0) groups.push({
					key: title,
					count
				});
			}
			if (ungrouped > 0) groups.push({
				key: UNGROUPED_KEY,
				count: ungrouped
			});
			return groups;
		...
		function inGroup(row, group, groups) {
			const title = (groups ?? {})[row.id];
			return group === "__ungrouped__" ? title === void 0 : title === group;
		}
		/**
		...
		*/
		function archivedSetOf(workspaces) {
			try {
		...
		*/
		function rowsOfSnapshot(snapshot, workspaces) {
			const state = asRecord(snapshot);
			if (state === null) return null;
			if (!Array.isArray(state.ids)) return null;
			const ids = state.ids.filter((id) => typeof id === "string");
			const archived = archivedSetOf(workspaces);
			const byId = asRecord(state.byId) ?? {};
			const current = typeof state.current === "string" ? state.current : void 0;
			const rows = [];
			for (const id of ids) {
				...
				try {
					...
					const displayTitle = typeof row.displayTitle === "string" && row.displayTitle !== "" ? row.displayTitle : void 0;
					const title = typeof row.title === "string" && row.title !== "" ? row.title : void 0;
					const cwd = typeof row.cwd === "string" && row.cwd !== "" ? row.cwd : void 0;
					...
					rows.push({
						...
						activity: activityOf$1(values?.contextActivity)
					});
				} catch {}
			}
			return rows;
		...
		function rangeStartOf(range, now) {
			if (range === "7d") return now - 6048e5;
			if (range === "30d") return now - 2592e6;
			return null;
		}
		/**
		...
		*/
		function billedOf(timeline) {
			return usageTotalsOf(timeline?.cost)?.total ?? null;
		}
		/** The session's turn tally: the split head's precomputed count, else the retained records' count. */
		function turnsOf(timeline) {
		...
		*/
		function createdDayOf(activity) {
			const days = activity?.days;
			if (days === void 0) return void 0;
			let first;
			for (const key of Object.keys(days)) if (first === void 0 || key < first) first = key;
			return first;
		}
		/**
		...
		*/
		function filterRows(rows, opts, now) {
			...
			return rows.filter((row) => {
				...
				if (opts.day !== null) {
					...
					if (entry === void 0 || entry.tokens <= 0 && entry.requests <= 0) return false;
				}
				if (query !== "") {
					const inTitle = row.title.toLowerCase().includes(query);
					const inCwd = row.cwd !== void 0 && row.cwd.toLowerCase().includes(query);
		...
		*/
		function pageOf(rows, page) {
			...
			return {
				items: rows.slice(index * 12, (index + 1) * 12),
				index,
				count
			};
		}
		...
		*/
		function refreshSessions(ctx) {
			try {
				const sessions = ctx.get("sessions");
				if (sessions === void 0 || typeof sessions.refresh !== "function") return;
		...
		* rows it already has.
		*/
		function requestActivityBackfill() {
			try {
				fetch(BACKFILL_ROUTE, { method: "POST" }).catch(() => {});
			} catch {}
		}
		/**
		...
		*/
		function relativeTime(t, updatedAt, now) {
			const diff = now - updatedAt;
			if (!Number.isFinite(diff) || diff < 6e4) return t("ov.time.now");
		...
		*/
		...
		//#endregion
		//#region src/client/components/heatmap.tsx
		/**
		...
		*/
		function gridWindowOf(today, days) {
			...
			for (let w = 0;; w++) {
				...
				if (sunday !== void 0 && sunday.key >= today) return columns;
			}
		}
		...
		function makeHeatmap(kit) {
			const { t } = kit;
			return function Heatmap(props) {
				const columns = props.windowDays === void 0 ? gridOf(props.today, props.weeks ?? 8) : gridWindowOf(props.today, props.windowDays);
				if (columns === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "lc-empty",
					children: t("ov.heat.empty")
				});
				const byKey = props.days;
				let max = 0;
				let any = false;
				for (const column of columns) for (const cell of column) {
					if (cell.future || cell.outside === true) continue;
					const entry = byKey[cell.key];
					if (entry === void 0 || entry.tokens <= 0 && entry.requests <= 0) continue;
					cell.entry = entry;
					any = true;
					if (entry.tokens > max) max = entry.tokens;
				}
				if (!any) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "lc-empty",
					children: t("ov.heat.empty")
				});
				const weekdayLabels = [
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "lc-heat",
					role: "group",
					"aria-label": t("ov.heat.title"),
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "lc-heat-wds",
						"aria-hidden": "true",
						children: [
							0,
							1,
							...
							5,
							6
						].map((col) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "lc-heat-wd",
							children: col === 0 ? weekdayLabels[0] : col === 2 ? weekdayLabels[1] : col === 4 ? weekdayLabels[2] : ""
						}, col))
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "lc-heat-cols",
						children: columns.map((column, wi) => {
							const opens = column[0].key.slice(0, 7) !== column[6].key.slice(0, 7) || column[0].key.slice(8, 10) === "01";
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "lc-heat-col",
								children: [opens && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "lc-heat-mon",
									"aria-hidden": "true",
									children: t("ov.heat.mon." + column[6].key.slice(5, 7))
								}), column.map((cell) => {
									if (cell.future || cell.outside === true) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "lc-heat-cell lc-heat-future",
										"aria-hidden": "true"
									}, cell.key);
									const level = cell.entry === void 0 ? 0 : levelOf(cell.entry.tokens, max);
									if (cell.entry === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
										label: cell.key,
										side: "top",
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: "lc-heat-cell lc-heat-0" })
									}, cell.key);
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											"aria-pressed": picked,
											onClick: () => {
												if (props.onSelect !== void 0) props.onSelect(picked ? null : cell.key);
											}
										})
									}, cell.key);
								})]
		...
		*/
		function platformBalanceOf(value) {
			const data = asRecord(value);
			if (data === null) return null;
			const infos = Array.isArray(data.balances) ? data.balances : [];
			const balances = [];
			for (const info of infos) try {
				...
				if (typeof currency !== "string" || currency === "" || total === null || granted === null || toppedUp === null) continue;
				balances.push({
					currency,
					total,
					granted,
		...
		*/
		function balanceEntryOf(balance, currency) {
			if (balance === null || balance === void 0 || balance.balances.length === 0) return null;
		...
		*/
		function fetchPlatformBalance() {
			if (cached$1 !== null && Date.now() - cached$1.at < TTL_MS$1) return cached$1.promise;
			const at = Date.now();
			const promise = (async () => {
				try {
					...
					const r = asRecord(await response.json());
					if (r === null || r.ok !== true || r.value === null || r.value === void 0) return null;
		...
		//#endregion
		//#region src/client/components/quotaCells.tsx
		/**
		...
		*/
		...
		function symbolOf(currency) {
			if (currency === "CNY") return String.fromCharCode(165);
			if (currency === "USD") return String.fromCharCode(36);
			return currency + " ";
		}
		...
		*/
		function windowsOf(account) {
			...
			for (const win of account.windows) {
				...
				if (current === void 0 || win.remainingPercent < current.remainingPercent) byLength.set(win.windowSeconds, win);
			}
			return [...byLength.values()].sort((left, right) => left.windowSeconds - right.windowSeconds).slice(0, WINDOWS_PER_ACCOUNT);
		}
		/** The account rows to render: the service's list, or the active account alone. */
		function accountsOf(quota) {
			...
			return [{
				...
				...quota.credits === void 0 ? {} : { credits: quota.credits }
			}];
		}
		/**
		...
		*/
		function makeQuotaGrid(ctx, kit) {
			const { t, fmtDuration } = kit;
			/** Read the optional codexQuota client service without requiring it. */
			function codexQuotaOf() {
				const probe = ctx;
				if (probe === void 0 || typeof probe.get !== "function") return null;
				const value = probe.get("codexQuota");
				if (value === null || typeof value !== "object") return null;
				const candidate = value;
				return typeof candidate.snapshot === "function" && typeof candidate.subscribe === "function" ? candidate : null;
			}
			/** Remaining time until one window resets, or null when unknown. */
			function resetInOf(win) {
				if (win.resetAt === void 0) return null;
				const left = win.resetAt * 1e3 - Date.now();
				return left > 0 ? fmtDuration(left) : null;
			}
			/** The exact reset instant in the reader's own locale and time zone. */
			function resetAtOf(win) {
				if (win.resetAt === void 0) return null;
				const at = /* @__PURE__ */ new Date(win.resetAt * 1e3);
				return Number.isNaN(at.getTime()) ? null : at.toLocaleString();
			}
			return function QuotaGrid(props) {
				const [balance, setBalance] = (0, react.useState)(null);
				const [detail, setDetail] = (0, react.useState)(null);
				(0, react.useEffect)(() => {
					let on = true;
					fetchPlatformBalance().then((value) => {
						if (on && value !== null) setBalance(value);
					});
					return () => {
						on = false;
					};
				...
				const quota = (0, react.useSyncExternalStore)(service?.subscribe ?? NEVER_CHANGES, service?.snapshot ?? NO_QUOTA);
				...
				const cell = (key, name, value, sub, target, chip) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "lc-ov-quota-label",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "lc-ov-quota-name",
									children: name
								}), chip ?? null]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-value",
								children: value
							}),
							sub !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-sub",
								children: sub
							})
						]
					}, key);
				...
				const summary = [];
				if (entry !== null) summary.push(cell("balance", t("ov.quota.balance"), symbolOf(entry.currency) + entry.total.toFixed(2), t("ov.quota.balanceSub", {
					granted: entry.granted.toFixed(2),
					topped: entry.toppedUp.toFixed(2)
				}), { kind: "balance" }));
				if (today !== void 0 && today.tokens > 0) summary.push(cell("today", t("ov.quota.today"), fmt(today.tokens), t("ov.kpi.tokens"), { kind: "today" }));
				const cells = [...summary];
				const rankOf = (accountKey) => {
					if (!named) return null;
					const rank = accounts.findIndex((candidate) => candidate.accountKey === accountKey) + 1;
					return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "lc-ov-quota-rank" + (accounts[rank - 1]?.active === true ? " lc-ov-quota-rank-on" : ""),
				...
				for (const account of accounts) {
					...
					for (const win of windows) {
						...
						cells.push(cell(key, t("ov.quota.codexWindow", { w: windowLabel(win.windowSeconds) }), t("ov.quota.remaining", { p: Math.round(win.remainingPercent) }), reset === null ? null : t("ov.quota.resetIn", { d: reset }), {
							kind: "window",
							key
				...
				if (detail !== null && detail.kind === "today" && today !== void 0) {
					...
					if (props.onSelectDay !== void 0) action = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: "lc-ov-quota-detail-action",
						onClick: (event) => {
							event.stopPropagation();
							props.onSelectDay?.(props.today);
						},
						children: t("ov.quota.detail.filterDay")
					});
				}
				if (detail !== null && detail.kind === "window") {
					...
					if (account !== void 0 && win !== void 0) {
						...
						rows.push([t("ov.quota.detail.length"), fmtDuration(win.windowSeconds * 1e3)]);
						...
						if (refreshed !== void 0) rows.push([t("ov.quota.detail.refreshed"), fmtDuration(Date.now() - refreshed) + " " + t("ov.quota.detail.ago")]);
					}
				}
				...
				const legend = !named ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "lc-ov-quota-legend",
					role: "group",
					"aria-label": t("ov.quota.legend"),
					children: accounts.map((account, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: "lc-ov-quota-legend-item",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-rank" + (account.active ? " lc-ov-quota-rank-on" : ""),
								children: "#" + String(index + 1)
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-legend-label",
								children: account.label === "" ? t("ov.quota.accountCurrent") : account.label
							}),
							account.active && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-legend-active",
								children: t("ov.quota.accountCurrent")
							})
						]
					}, account.accountKey))
				});
				const panel = rows.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "lc-ov-quota-detail",
					role: "group",
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "lc-ov-quota-detail-head",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-detail-title",
						...
						rows.map(([label, value]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "lc-ov-quota-detail-row",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-detail-label",
								children: label
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-quota-detail-value",
								children: value
							})]
						}, label)),
						action
				...
				if (props.compact === true) {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "lc-ov-quota lc-ov-quota-compact",
						children: [
							summary,
							accounts.map((account, index) => {
								const accountOpen = detail !== null && detail.kind === "account" && detail.key === account.accountKey;
								const windows = windowsOf(account);
								const reset = windows.map((win) => resetInOf(win)).filter((value) => value !== null).join(" · ");
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: "lc-ov-quota-account-head",
										children: [named ? rankOf(account.accountKey) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: "lc-ov-quota-account-name",
											children: account.label === "" ? t("ov.quota.accountCurrent") : account.label
										})]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "lc-ov-quota-account-windows",
										children: windows.map((win) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: "lc-ov-quota-window",
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "lc-ov-quota-window-label",
												children: windowLabel(win.windowSeconds)
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "lc-ov-quota-window-value",
												children: String(Math.round(win.remainingPercent)) + "%"
											})]
										}, account.accountKey + ":" + String(win.windowSeconds)))
									})]
								}, account.accountKey);
							}),
							panel
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "lc-ov-quota" + (cells.length >= 6 ? " lc-ov-quota-multi" : ""),
					children: [
						cells,
						legend,
						panel
		...
		//#endregion
		//#region src/client/components/overviewButton.tsx
		/**
		...
		*/
		function makeOverviewButton(kit, ctx, settings) {
			const { t } = kit;
			const QuotaGrid = makeQuotaGrid(ctx, kit);
			const subscribeEntry = settings === void 0 ? subscribeNever : (listener) => settings.store.subscribe(listener);
			const getEntry = settings === void 0 ? entryShown : () => settings.insightsEntry();
			return function OverviewButton(props) {
				const entry = (0, react.useSyncExternalStore)(subscribeEntry, getEntry);
				const snapshot = sessionsSnapshotOf(props);
				const days = (0, react.useMemo)(() => {
					const rows = rowsOfSnapshot(snapshot, void 0);
				...
				if (props.wide !== true) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: "lc-ov-entry lc-ov-entry-rail",
					title: t("ov.entry"),
					"aria-label": t("ov.entry"),
					onClick: open,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ContextIcon, {
						size: 18,
						className: "lc-ov-entry-icon"
					})
				});
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "lc-ov-widget-head",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ContextIcon, {
								size: 14,
								className: "lc-ov-entry-icon"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-widget-title",
								children: t("ov.entry")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "lc-ov-widget-more",
								"aria-hidden": "true",
								children: String.fromCharCode(8250)
							})
						]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(QuotaGrid, {
						days,
						today: todayKey(),
						compact: true,
						onSelectDay: (day) => {
							overviewStore.open(day ?? void 0);
						}
					})]
				});
			};
		...
		*/
		...
		function makeOverviewPanel(ctx, kit) {
			...
			function OverviewBody(props) {
				...
				(0, react.useEffect)(() => {
					if (open) setDay(overviewStore.day());
				}, [open]);
				...
				const [heatDays, setHeatDays] = (0, react.useState)(30);
				...
				const now = Date.now();
				const allRows = rows ?? [];
				const ranged = filterRows(allRows, {
					range,
					day: null,
					query: ""
				}, now);
				const scoped = filterRows(ranged, {
					range: "all",
					day,
					query
				}, now);
				const counts = groupCountsOf(scoped, wsSnapshot);
				const chips = group !== null && !counts.some((c) => c.key === group) ? [...counts, {
					key: group,
					count: 0
				}] : counts;
				const visible = sortRows(group === null ? scoped : scoped.filter((row) => inGroup(row, group, groups)), sort);
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "lc-ov-backdrop",
					onClick: close,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "lc-ov-card",
						onClick: (ev) => {
							ev.stopPropagation();
						},
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "lc-ov-head",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ContextIcon, {
									size: 18,
									className: "lc-ov-head-icon"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "lc-ov-title",
									children: t("ov.title")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "lc-gran lc-ov-range",
									role: "group",
									"aria-label": t("ov.range.label"),
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: "lc-card-title-text",
													children: t("ov.heat.title")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: "lc-card-sub",
													children: t("ov.heat.sub")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
													className: "lc-gran lc-ov-heat-range",
													role: "group",
													"aria-label": t("ov.heat.title"),
													children: [7, 30].map((n) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "button",
														className: "lc-gran-btn" + (heatDays === n ? " lc-gran-on" : ""),
														onClick: () => {
															setHeatDays(n);
														},
														children: t(n === 7 ? "ov.range.7d" : "ov.range.30d")
													}, n))
												})
											]
			...
			return function OverviewPanel(props) {
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ErrorBoundary, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OverviewBody, { ...props }) });
			};
		}
		/** One card's priced cost label, or the dash (no book yet, nothing billed, unpriceable model). */
		function cardCostOf(row, prices, currency) {
			if (row.timeline?.cost === void 0) return "—";
		...
		*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [active, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutlineRegular, { size: 14 })]
					})
				})]
			});
		}
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PrefRow, {
								...
								options: [{
									id: "show",
									label: t("insightsEntry.show")
								}, {
									id: "hide",
									label: t("insightsEntry.hide")
								}],
								onPick: (id) => {
									props.set?.("insightsEntry", id);
								}
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PrefRow, {
		...
		function createContextSettings() {
			...
			const listeners = /* @__PURE__ */ new Set();
			const publish = (next) => {
				if (next.status === state.status && next.placement === state.placement && next.granularity === state.granularity && next.mode === state.mode && next.toolSort === state.toolSort && next.fileSort === state.fileSort && next.insightsEntry === state.insightsEntry && next.writable === state.writable) return;
				state = next;
				for (const listener of listeners) listener();
			};
			const sync = (bound) => {
				...
				const raw = snap.value !== null && typeof snap.value === "object" ? snap.value : void 0;
				publish({
					status: snap.status === "ready" || snap.status === "unavailable" ? snap.status : "loading",
					placement: prefs.placement ?? (raw?.defaultPlacement === void 0 ? state.placement : "all"),
					...
					insightsEntry: prefs.insightsEntry ?? (raw?.insightsEntry === void 0 ? state.insightsEntry : "show"),
					writable: snap.writable
				});
				return {
					placement: prefs.placement,
					insightsEntry: prefs.insightsEntry
				};
			};
			return {
				store: {
				...
				set(field, value) {
					...
					bound.set(field, value).catch(() => {
						...
						if (field === "defaultPlacement" && truth.placement === void 0) publish({
							...state,
							placement: "all"
						});
						if (field === "insightsEntry" && truth.insightsEntry === void 0) publish({
							...state,
							insightsEntry: "show"
						});
					});
		...
		*/
		...
		//#endregion
		//#region src/client/agentHeads.ts
		/**
		...
		*/
		function agentForestOf(snapshot, currentId, self, fetched) {
			...
			const visit = (id, row, parentId, depth, seen, family) => {
				...
				const fetchedHead = fetched !== void 0 ? fetched.get(id) : void 0;
				const stats = agentStatsOf(fetchedHead !== void 0 && values?.contextTimeline === void 0 ? {
					...values,
					contextTimeline: fetchedHead
				} : values);
		...
		*/
		function subagentCostFoldOf(snapshot, currentId, landed) {
			const byId = asRecord(asRecord(snapshot)?.byId);
			if (byId === null || currentId === void 0 || currentId === "") return {
				usage: null,
				cold: []
			};
			const childrenOf = /* @__PURE__ */ new Map();
			for (const key of Object.keys(byId)) {
				const row = agentRowOf(byId[key]);
				if (row === null || row.blank || row.parentId === void 0) continue;
				const list = childrenOf.get(row.parentId) ?? [];
				list.push(key);
				childrenOf.set(row.parentId, list);
			}
			const parts = [];
			const cold = [];
			const seen = /* @__PURE__ */ new Set([currentId]);
			...
			for (let i = 0; i < queue.length; i++) {
				...
				for (const kid of childrenOf.get(id) ?? []) {
					...
					if (values?.contextTimeline === void 0) {
						if (head === void 0) cold.push(kid);
						else if (head.cost !== void 0) parts.push(head.cost);
					} else {
			...
			return {
				usage: parts.length > 0 ? mergeCostUsage(...parts) : null,
				cold
			};
		}
		/**
		...
		*/
		...
		function makeAgentGraph(ctx, kit, heads = makeAgentHeads(ctx)) {
			const { t, fmt, catLabel } = kit;
			function AgentGraph(props) {
				...
				const [landed, setLanded] = (0, react.useState)(/* @__PURE__ */ new Map());
			...
			return function EventList(props) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: sorted.map((ev) => {
						...
						const at = eventAt(ev);
						const glyph = ev.kind === "inject" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutlineRegular, { size: 16 }) : ev.kind === "model" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconBranchOutlineRegular, { size: 16 }) : EVENT_ICONS[ev.kind] || "•";
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		function makePluginInfo(kit) {
			...
			return function PluginInfo() {
				...
				const update = latest !== null && isNewerVersion(latest, "0.54.0") ? latest : null;
				const nameText = "dsh-context (v0.54.0)";
		...
		function priceRowsOf(usage, prices) {
			...
			for (const provider of Object.keys(usage)) {
				...
				for (const model of Object.keys(models)) {
					...
					const periods = asRecord(models[model]);
					const deepseek = isDeepSeekProvider(provider);
					const billedOff = deepseek && periods !== null && periods.off !== void 0;
					rows.push({
						key: provider + "/" + model,
		...
		*/
		function makeSubagentCost(ctx, heads) {
			return function useSubagentCost(sessionId) {
				const snapshot = useSessionsSnapshot((0, react.useMemo)(() => sessionsFaceOf(ctx), []));
				const [landed, setLanded] = (0, react.useState)(/* @__PURE__ */ new Map());
				const fold = (0, react.useMemo)(() => subagentCostFoldOf(snapshot, sessionId, landed), [
					snapshot,
					sessionId,
					landed
				]);
				(0, react.useEffect)(() => {
					for (const id of fold.cold) heads.headOf(id).then((head) => {
						if (head !== null) setLanded((prev) => prev.get(id) === head ? prev : new Map(prev).set(id, head));
					}).catch(() => {});
				}, [fold, heads]);
				return fold.usage;
		...
		function makeStatsContext(kit, useSubagentCost) {
			const { t, fmt } = kit;
			return function StatsContext(props) {
				...
				const usage = mergeCostUsage(props.cost, subUsage) ?? void 0;
				...
				const deepseek = usage !== void 0 && Object.keys(usage).some((p) => isDeepSeekProvider(p));
				...
				const unpriced = rows.length === 0 && usage !== void 0 && Object.keys(usage).length > 0 && (failed || prices !== null);
				const subUnpriced = subUsage !== null && priceRowsOf(subUsage, prices).length === 0 && (failed || prices !== null);
				const costTip = [
				...
				const subTip = [t("stats.subCostTip") + (subDeepseek ? " " + t("stats.costTipDeepseek") : ""), subUnpriced ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("stats.costUnavailable") }, "unavailable") : null];
		...
		*/
		function subscribeContextFocus(listener) {
		...
		* fallback.
		*/
		function openContextSidebar(ctx) {
			try {
				const face = asRecord(ctx.get("sidebarRight"));
				if (face === null || typeof face.openTab !== "function") return false;
				face.openTab.call(face, SIDEBAR_CONTEXT_KIND);
				return true;
			} catch {
				return false;
			}
		...
		*/
		...
		//#endregion
		//#region src/client/revealScroll.ts
		/**
		...
		*/
		function revealInScrollParent(anchor) {
			try {
		...
		*/
		...
		function makeContextJumpButton(ctx, kit) {
			const { t } = kit;
		...
		*/
		...
		//#endregion
		//#region \0dsh-global-css:D:\dsh-plugins\dsh-context\src\client\styles\attachments.css.mjs
		const css$2 = ".lc-att-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;padding:8px 10px;display:grid}.lc-att-item{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;font:inherit;text-align:left;cursor:pointer;transition:border-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out), background-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out);background:0 0;border-radius:8px;align-items:center;gap:8px;padding:6px;display:flex}.lc-att-thumb{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:6px;flex:none;justify-content:center;align-items:center;width:64px;height:64px;padding:0;display:flex;overflow:hidden}.lc-att-thumb img{object-fit:cover;width:100%;height:100%;display:block}.lc-att-ph,.lc-att-err{color:var(--dsw-alias-label-secondary);text-align:center;padding:2px;font-size:10px}.lc-att-meta{flex-direction:column;gap:2px;min-width:0;display:flex}.lc-att-name{color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;word-break:break-word;font-size:12px;line-height:1.3}.lc-att-row{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:11px}.lc-att-row-label{min-width:3.2em;font-weight:400;display:inline-block}.lc-att-lightbox{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.lc-att-lightbox-mask{background:var(--dsw-alias-bg-mask-1,#00000073);backdrop-filter:var(--dsw-mask-blur,blur(2px));position:absolute;inset:0}.lc-att-lightbox-img{object-fit:contain;background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-1));max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3,0 12px 32px #0006);border-radius:12px;position:relative}.lc-att-lightbox-close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin,var(--dsw-alias-border-l1));background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-1));width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:fixed;top:20px;right:20px}";
		const tagId$2 = "dsh-context/attachments.css";
		...
		//#endregion
		//#region \0dsh-global-css:D:\dsh-plugins\dsh-context\src\client\styles\overview.css.mjs
		const css = ".lc-ov-entry{box-sizing:border-box;width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.lc-ov-entry:hover{background:var(--dsw-alias-interactive-bg-hover)}.lc-ov-entry-rail{border-radius:50%;flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}.lc-ov-entry-icon{flex:none}.lc-ov-entry-label{text-align:left;white-space:nowrap;text-overflow:ellipsis;flex:auto;min-width:0;overflow:hidden}.lc-ov-backdrop{--lc-ov-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,var(--color-blue-500));z-index:200;background:var(--dsw-alias-bg-mask-1,#00000073);box-sizing:border-box;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0;container:lc-ov/inline-size}.lc-ov-card{box-sizing:border-box;background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);width:min(1080px,100vw - 96px);max-height:min(84vh,880px);box-shadow:var(--dsw-shadow-lv3,0 12px 32px #0006);color:var(--dsw-alias-label-primary);border-radius:12px;flex-direction:column;padding:16px 18px 18px;font-size:13px;display:flex;overflow:hidden}.lc-ov-head{flex-wrap:wrap;flex:none;align-items:center;gap:10px;margin-bottom:14px;display:flex}.lc-ov-head-icon{flex:none}.lc-ov-title{white-space:nowrap;font-size:15px;font-weight:600}.lc-ov-balance{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);cursor:default;border-radius:999px;flex:none;align-items:center;gap:6px;max-width:100%;padding:2px 10px;font-size:12px;line-height:18px;display:inline-flex}.lc-ov-balance-label{color:var(--dsw-alias-label-secondary);white-space:nowrap}.lc-ov-balance-value{font-variant-numeric:tabular-nums;white-space:nowrap;font-weight:600}.lc-ov-head .lc-modal-close{flex:none;margin-left:0}.lc-ov-body{flex:auto;grid-template-columns:minmax(0,3fr) minmax(0,7fr);gap:10px;min-height:0;display:grid}.lc-ov-left{scrollbar-gutter:stable;flex-direction:column;gap:10px;min-height:0;padding-right:8px;display:flex;overflow-y:auto}.lc-ov-right{scrollbar-gutter:stable;min-height:0;padding-right:8px;overflow-y:auto}@container lc-ov (width<=932px){.lc-ov-card{overflow-y:auto}.lc-ov-body{display:block}.lc-ov-left{margin-bottom:12px}.lc-ov-left,.lc-ov-right{min-height:auto;padding-right:0;overflow:visible}.lc-ov-heat-card{flex:none}}.lc-ov-left>.lc-card{box-sizing:border-box;min-width:0;margin-bottom:0}.lc-ov-kpis{flex:none;grid-template-rows:repeat(3,1fr);grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;display:grid}.lc-ov-kpi{align-items:center;padding:10px 8px}.lc-ov-kpi .lc-stat-value{font-size:20px}.lc-ov-heat-card{flex-direction:column;flex:1 0 auto;display:flex}.lc-heat{--lc-heat-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,var(--color-blue-500));flex-direction:column;flex:1;justify-content:center;align-items:flex-start;gap:3px;display:flex}.lc-heat-wds,.lc-heat-col{padding-left:30px}.lc-heat-wds{flex-direction:row;gap:3px;display:flex}.lc-heat-wd{width:20px;height:12px;color:var(--dsw-alias-label-secondary);text-align:center;flex:none;justify-content:center;align-items:center;font-size:9px;display:flex}.lc-heat-cols{flex-direction:column;gap:3px;display:flex}.lc-heat-col{flex-direction:row;gap:3px;display:flex;position:relative}.lc-heat-mon{width:26px;color:var(--dsw-alias-label-secondary);white-space:nowrap;font-size:9px;line-height:20px;position:absolute;top:0;left:0;overflow:hidden}.lc-heat-cell{box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);cursor:default;border:0;border-radius:24%;width:20px;height:20px;padding:0}button.lc-heat-cell{cursor:pointer}button.lc-heat-cell:hover{box-shadow:0 0 0 1.5px color-mix(in srgb, var(--lc-heat-accent) 70%, transparent)}.lc-heat-future{background:0 0}.lc-heat-0{background:color-mix(in srgb, var(--dsw-alias-label-secondary) 16%, transparent)}.lc-heat-1{background:color-mix(in srgb, var(--lc-heat-accent) 26%, transparent)}.lc-heat-2{background:color-mix(in srgb, var(--lc-heat-accent) 48%, transparent)}.lc-heat-3{background:color-mix(in srgb, var(--lc-heat-accent) 70%, transparent)}.lc-heat-4{background:color-mix(in srgb, var(--lc-heat-accent) 92%, transparent)}.lc-heat-on{box-shadow:0 0 0 1.5px var(--lc-heat-accent)}.lc-ov-list-head{flex-wrap:wrap;align-items:center;gap:10px;margin-bottom:10px;display:flex}.lc-ov-list-title{white-space:nowrap;font-weight:600}.lc-ov-list-count{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;background:var(--dsw-alias-bg-layer-2);border-radius:8px;padding:1px 7px;font-size:11px}.lc-ov-day-chip{border:1px solid color-mix(in srgb, var(--lc-ov-accent) 45%, transparent);color:var(--lc-ov-accent);background:color-mix(in srgb, var(--lc-ov-accent) 10%, transparent);cursor:pointer;white-space:nowrap;border-radius:999px;padding:1px 10px;font-family:inherit;font-size:11px;line-height:1.4}.lc-ov-search{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);min-width:110px;font:inherit;color:var(--dsw-alias-label-primary);transition:border-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out);border-radius:6px;outline:none;flex:150px;padding:4px 10px;font-size:12px}.lc-ov-search:focus{border-color:var(--dsw-alias-label-secondary)}.lc-ov-search::placeholder{color:var(--dsw-alias-label-secondary)}.lc-ov-groups{flex-wrap:wrap;gap:6px;margin:-2px 0 10px;display:flex}.lc-ov-chip{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;white-space:nowrap;text-overflow:ellipsis;max-width:220px;transition:color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out), border-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out), background-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out);background:0 0;border-radius:999px;align-items:baseline;gap:5px;padding:2px 10px;font-size:11px;line-height:1.5;display:inline-flex;overflow:hidden}.lc-ov-chip:hover{color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-secondary)}.lc-ov-chip-on,.lc-ov-chip-on:hover{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground);border-color:#0000}.lc-ov-chip-n{font-variant-numeric:tabular-nums;opacity:.65;font-size:10px}.lc-ov-chip-on .lc-ov-chip-n{opacity:.85}.lc-ov-grid{grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:10px;display:grid}.lc-ov-session{text-align:left;background:var(--dsw-alias-bg-layer-1);border:1px solid var(--dsw-alias-border-l2);cursor:pointer;font:inherit;color:inherit;transition:border-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out), background-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out);border-radius:10px;flex-direction:column;gap:6px;padding:10px 12px;display:flex}.lc-ov-session:hover{border-color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2)}.lc-ov-session-current{border-color:color-mix(in srgb, var(--lc-ov-accent) 65%, transparent)}.lc-ov-session-head{align-items:flex-start;gap:6px;min-width:0;display:flex}.lc-ov-running{background:var(--color-green-500);border-radius:50%;flex:none;width:7px;height:7px}.lc-ov-session-title{-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;flex:auto;min-width:0;font-weight:600;display:-webkit-box;overflow:hidden}.lc-ov-current{color:var(--lc-ov-accent);border:1px solid color-mix(in srgb, var(--lc-ov-accent) 45%, transparent);border-radius:4px;flex:none;padding:0 4px;font-size:10px;line-height:1.5}.lc-ov-session-times{flex-direction:column;flex:none;align-items:flex-end;gap:1px;display:flex}.lc-ov-session-time{color:var(--dsw-alias-label-secondary);white-space:nowrap;font-size:11px}.lc-ov-session-created{color:var(--dsw-alias-label-secondary);white-space:nowrap;font-variant-numeric:tabular-nums;font-size:10px;line-height:1.4}.lc-ov-session-crumb{min-width:0;color:var(--dsw-alias-label-secondary);white-space:nowrap;align-items:center;gap:5px;font-size:11px;display:flex;overflow:hidden}.lc-ov-crumb-group{text-overflow:ellipsis;flex:none;max-width:55%;overflow:hidden}.lc-ov-crumb-sep{opacity:.55;flex:none}.lc-ov-crumb-project{text-overflow:ellipsis;min-width:0;font-family:var(--ds-font-family-code,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-label-secondary) 16%, transparent);border-radius:999px;flex:0 auto;padding:0 8px;font-size:10px;line-height:1.6;overflow:hidden}.lc-ov-session-body{align-items:center;gap:14px;min-width:0;display:flex}.lc-ov-mini-stats{flex-direction:column;flex:auto;gap:3px;min-width:0;display:flex}.lc-ov-mini-stat{justify-content:space-between;align-items:baseline;gap:10px;font-size:11px;display:flex}.lc-ov-mini-label{color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none}.lc-ov-mini-value{font-variant-numeric:tabular-nums;white-space:nowrap;font-weight:600}.lc-ov-session-empty{color:var(--dsw-alias-label-secondary);padding:6px 0;font-size:11px;line-height:1.5}.lc-ov-session-preview{border-top:1px solid color-mix(in srgb, var(--dsw-alias-border-l2) 60%, transparent);align-items:baseline;gap:6px;min-width:0;margin-top:auto;padding-top:6px;display:flex}.lc-ov-session-preview-label{color:var(--dsw-alias-label-secondary);flex:none;font-size:10px}.lc-ov-session-preview-text{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:0 auto;font-size:11px;line-height:1.5;overflow:hidden}.lc-ov-pager{justify-content:center;align-items:center;gap:10px;margin-top:12px;display:flex}.lc-ov-pager-btn{border:1px solid var(--dsw-alias-border-l2);width:26px;height:22px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;transition:border-color var(--ds-transition-duration,.2s) var(--ds-ease-in-out,ease-in-out);background:0 0;border-radius:6px;flex:none;justify-content:center;align-items:center;line-height:1;display:flex}.lc-ov-pager-btn:hover:enabled{border-color:var(--dsw-alias-label-secondary)}.lc-ov-pager-btn:disabled{opacity:.4;cursor:default}.lc-ov-pager-n{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:11px}.lc-ov-quota{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;display:grid}.lc-ov-quota-multi{grid-template-columns:repeat(auto-fit,minmax(108px,1fr))}.lc-ov-quota-cell{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);min-width:0;font:inherit;color:inherit;text-align:left;cursor:pointer;border-radius:10px;flex-direction:column;gap:2px;padding:8px 10px;transition:border-color .12s,background .12s;display:flex}.lc-ov-quota-cell:hover{border-color:color-mix(in srgb, var(--lc-ov-accent) 45%, var(--dsw-alias-border-l2))}.lc-ov-quota-cell:focus-visible{outline:2px solid color-mix(in srgb, var(--lc-ov-accent) 60%, transparent);outline-offset:1px}.lc-ov-quota-on{border-color:color-mix(in srgb, var(--lc-ov-accent) 65%, transparent)}.lc-ov-quota-label{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;gap:4px;font-size:12px;display:flex}.lc-ov-quota-value{white-space:nowrap;text-overflow:ellipsis;font-size:15px;font-weight:600;overflow:hidden}.lc-ov-quota-sub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;overflow:hidden}.lc-ov-quota-name{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.lc-ov-quota-rank{background:color-mix(in srgb, var(--dsw-alias-label-secondary) 14%, transparent);color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;border-radius:999px;flex:none;margin-left:auto;padding:0 5px;font-size:10px;line-height:15px}.lc-ov-quota-rank-on{background:color-mix(in srgb, var(--lc-ov-accent) 16%, transparent);color:var(--lc-ov-accent)}.lc-ov-quota-legend{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;grid-column:1/-1;align-items:center;gap:2px 12px;font-size:10px;display:flex}.lc-ov-quota-legend-item{align-items:center;gap:4px;min-width:0;display:inline-flex}.lc-ov-quota-legend-label{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.lc-ov-quota-legend-active{color:var(--lc-ov-accent)}.lc-ov-quota-legend .lc-ov-quota-rank{margin-left:0}.lc-ov-quota-detail{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 80%, transparent);border-radius:10px;flex-direction:column;grid-column:1/-1;gap:4px;padding:8px 10px;display:flex}.lc-ov-quota-detail-head{align-items:center;gap:6px;display:flex}.lc-ov-quota-detail-title{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600}.lc-ov-quota-detail-close{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;margin-left:auto;padding:2px 5px;font-size:13px;line-height:1}.lc-ov-quota-detail-close:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.lc-ov-quota-detail-row{align-items:baseline;gap:8px;font-size:12px;display:flex}.lc-ov-quota-detail-label{color:var(--dsw-alias-label-secondary)}.lc-ov-quota-detail-value{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);margin-left:auto}.lc-ov-quota-detail-action{border:1px solid color-mix(in srgb, var(--lc-ov-accent) 45%, transparent);color:var(--lc-ov-accent);background:color-mix(in srgb, var(--lc-ov-accent) 10%, transparent);font:inherit;cursor:pointer;border-radius:999px;align-self:flex-start;margin-top:2px;padding:2px 10px;font-size:11px}.lc-ov-quota-detail-action:hover{background:color-mix(in srgb, var(--lc-ov-accent) 18%, transparent)}.lc-ov-heat-range{margin-left:auto}.lc-ov-widget{--lc-ov-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,var(--color-blue-500));border:1px solid color-mix(in srgb, var(--dsw-alias-border-l2) 70%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 62%, transparent);-webkit-backdrop-filter:blur(18px)saturate(150%);box-shadow:var(--dsw-shadow-lv1,0 2px 10px #0000002e);box-sizing:border-box;cursor:pointer;border-radius:12px;flex-direction:column;gap:6px;width:100%;min-width:0;margin:2px 0 6px;padding:8px 9px 9px;transition:background .12s,box-shadow .12s;display:flex}.lc-ov-widget:hover{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 78%, transparent);box-shadow:var(--dsw-shadow-lv2,0 4px 16px #00000038)}.lc-ov-widget:focus-visible{outline:2px solid color-mix(in srgb, var(--lc-ov-accent) 60%, transparent);outline-offset:2px}.lc-ov-widget-head{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;display:flex}.lc-ov-widget-title{font-weight:600}.lc-ov-widget-more{opacity:.5;margin-left:auto}.lc-ov-quota-compact{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.lc-ov-quota-account{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 72%, transparent);min-width:0;font:inherit;color:inherit;text-align:left;cursor:pointer;border-radius:8px;grid-column:1/-1;align-items:center;gap:8px;padding:5px 8px;transition:border-color .12s;display:flex}.lc-ov-quota-account:hover{border-color:color-mix(in srgb, var(--lc-ov-accent) 45%, var(--dsw-alias-border-l2))}.lc-ov-quota-account-head{align-items:center;gap:4px;min-width:0;display:flex}.lc-ov-quota-account .lc-ov-quota-rank{margin-left:0}.lc-ov-quota-account-name{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.lc-ov-quota-account-windows{font-variant-numeric:tabular-nums;flex:none;align-items:baseline;gap:10px;margin-left:auto;display:flex}.lc-ov-quota-window{align-items:baseline;gap:3px;display:inline-flex}.lc-ov-quota-window-label{color:var(--dsw-alias-label-tertiary);font-size:10px}.lc-ov-quota-window-value{font-size:12px;font-weight:600}.lc-ov-quota-compact .lc-ov-quota-cell{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 72%, transparent);border-radius:8px;padding:6px 7px}.lc-ov-quota-compact .lc-ov-quota-label{font-size:10px}.lc-ov-quota-compact .lc-ov-quota-value{font-size:13px}.lc-ov-quota-compact .lc-ov-quota-sub{font-size:10px}";
		...
		function apply(ctx) {
			...
			ctx.slots.inject("sidebar.footer.action", () => {
				return ctx.slots.register({
					...
					order: 10,
					locale: NS
				}, (props) => (0, react.createElement)(OverviewButton, props));
			});
			...
			ctx.slots.inject("shell.overlay", () => {
				return ctx.slots.register({
					...
					order: 10,
					locale: NS
				}, (props) => (0, react.createElement)(OverviewPanel, props));
			});
