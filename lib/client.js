		...
		*/
		function makeQuotaGrid(ctx, kit) {
			...
			return function QuotaGrid(props) {
				...
				const cells = [];
				if (entry !== null) cells.push(cell("balance", t("ov.quota.balance"), symbolOf(entry.currency) + entry.total.toFixed(2), t("ov.quota.balanceSub", {
					granted: entry.granted.toFixed(2),
					topped: entry.toppedUp.toFixed(2)
				}), { kind: "balance" }));
				if (today !== void 0 && today.tokens > 0) cells.push(cell("today", t("ov.quota.today"), fmt(today.tokens), t("ov.kpi.tokens"), { kind: "today" }));
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "lc-ov-quota" + (props.compact === true ? " lc-ov-quota-compact" : ""),
					children: [
						cells,
						legend,
						panel
